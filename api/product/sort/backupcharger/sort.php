<?php
    ...
    $brand = null; $price = null; $capacity = null; $input = null; $output = null; $charger = null;
    ...
    if(isset($data->capacity) && strlen($data->capacity) > 0){
        if (strpos($data->capacity, '-') === false) {
            $capacity = $data->capacity;
        } else {
            $capacity = explode("-", $data->capacity);
        }
    }
    ...
    $sort = $backupcharger->sort($brand, $price, $capacity, $input, $output, $charger);
    $num = $sort->rowCount();
